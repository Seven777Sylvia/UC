...
public class Constant {
    ...
    //wallet icon color
    public static final int WALLET_ICON_COLOR_SKY = 0;
    public static final int WALLET_ICON_COLOR_ORANGE = 1;
    public static final int WALLET_ICON_COLOR_PURPLE = 2;
    public static final int WALLET_ICON_COLOR_OCEAN = 3;
    public static final int WALLET_ICON_COLOR_YELLWO = 4;
