...
public class OkHttpClientManager {
    ...
    public void postJson(String url, String jsonStr, final INetCallback iNetCallback) {
        if (TextUtils.isEmpty(url) || TextUtils.isEmpty(jsonStr)) {
            UChainLog.e(TAG, "postJson() -> url or jsonStr is null or empty!");
            return;
        }

        if (null == iNetCallback) {
            UChainLog.e(TAG, "postJson() -> iNetCallback is null!");
            return;
        }
        ...
        call.enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                if (null == responseBody) {
                    ...
                    UChainLog.e(TAG, "onResponse() -> responseBody is null");
                    return;
                }
    ...
    public void get(String url, final INetCallback iNetCallback) {
        if (TextUtils.isEmpty(url)) {
            UChainLog.e(TAG, "get() -> url is null!");
            return;
        }

        if (null == iNetCallback) {
            UChainLog.e(TAG, "get() -> iNetCallback is null!");
            return;
        }
