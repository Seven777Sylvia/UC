...
public class GsonUtils {
    ...
    public static String toJsonStr(Object object) {
        ...
        if (null != sGson) {
            try {
                ...
                UChainLog.e(TAG, "toJsonStr() is exception:" + e.getMessage());
            }
        }
        return jsonStr;
    }
    ...
    public static <T> T json2Bean(String jsonStr, Class<T> cls) {
        ...
        if (null != sGson) {
            try {
                ...
                UChainLog.e(TAG, "json2Bean() is exception:" + e.getMessage());
            }
        }
        return t;
    }
    ...
    public static <T> List<T> json2List(String listJson, Class<T> cls) {
        ...
        try {
            ...
            UChainLog.e(TAG, "json2List() is exception:" + e.getMessage());
        }
        return list;
    }
