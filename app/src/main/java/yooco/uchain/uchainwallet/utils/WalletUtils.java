...
public class WalletUtils {
    ...
    public static String toDecString(String oxHexString, String assetDecimal) {
        if (TextUtils.isEmpty(oxHexString) || TextUtils.isEmpty(assetDecimal)) {
            UChainLog.e(TAG, "oxHexString or assetDecimal is null!");
            return null;
        }

        int length = oxHexString.length();
        if (length < 3) {
            UChainLog.w(TAG, "oxHexString.length < 3!");
            return "0";
        }
        ...
        try {
            ...
            UChainLog.e(TAG, "toDecString exception:" + e.getMessage());
            return null;
        }
    ...
    public static String toHexString(String decString, String decimal) {
        if (TextUtils.isEmpty(decString) || TextUtils.isEmpty(decimal)) {
            UChainLog.e(TAG, "decString or decimal is null!");
            return "";
        }
        ...
        try {
            ...
            UChainLog.i(TAG, "bigDecString:" + bigDecString);
            hexString = new BigInteger(bigDecString, 10).toString(16);
        } catch (Exception e) {
            UChainLog.e(TAG, "toHexString Exception:" + e.getMessage());
            return "";
        }
    ...
    public static String toLegalDecString(String decString, int decimal) {
        UChainLog.i(TAG, "toLegalDecString, decString:" + decString);
        ...
        try {
            ...
            UChainLog.e(TAG, "toLegalDecString Exception:" + e.getMessage());
            return "";
        }

        UChainLog.i(TAG, "toLegalDecString, legalDecString:" + legalDecString);
    ...
    public static String toLegalGasPrice(String decString, int decimal) {
        ...
        try {
            ...
            UChainLog.e(TAG, "toLegalGasPrice Exception:" + e.getMessage());
            return "0";
        }
