        ...
        if (holder instanceof GeneraTagsHolder) {
            ...
            if (null == adapter) {
                ...
                FlexboxLayoutManager layoutManager = new FlexboxLayoutManager
                        (UChainWalletApplication.getInstance());
                ...
                int space = DensityUtil.dip2px(UChainWalletApplication.getInstance(), 3);
                ...
                portraitTagsAdapter.setOnItemClickListener(new PortraitTagsAdapter
                    ...
                    public void onItemClick(int position) {
                        ...
                        UChainLog.i(TAG, "portraitTagsBean:" + portraitTagsBean.toString());
                    }
                });
