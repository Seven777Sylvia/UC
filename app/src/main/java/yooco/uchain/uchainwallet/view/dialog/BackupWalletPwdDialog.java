...
import yooco.uchain.uchainwallet.view.page.wallet.BackupWalletActivity;
...
public class BackupWalletPwdDialog extends DialogFragment implements View.OnClickListener,
    ...
    public void fromKeystoreToNeoWallet(Wallet wallet) {
        ...
        Intent intent = new Intent(UChainWalletApplication.getInstance(), BackupWalletActivity.class);
