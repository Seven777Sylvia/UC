    ...
    public void onBindViewHolder(@NonNull TransactionRecordAdapterHolder holder, int position) {
        ...
        switch (transactionRecord.getTxState()) {
            case Constant.TRANSACTION_STATE_FAIL:
                ...
                holder.txState.setTextColor(UChainWalletApplication.getInstance().getResources().getColor(R.color.c_E16A67));
            ...
            case Constant.TRANSACTION_STATE_SUCCESS:
                ...
                holder.txState.setTextColor(UChainWalletApplication.getInstance().getResources().getColor(R.color.c_54CA80));
            ...
            case Constant.TRANSACTION_STATE_CONFIRMING:
                ...
                holder.txState.setTextColor(UChainWalletApplication.getInstance().getResources().getColor(R.color.c_1253BF));
                holder.txTime.setVisibility(View.VISIBLE);
                break;
            case Constant.TRANSACTION_STATE_PACKAGING:
                holder.txState.setText(R.string.tx_blocking);
                holder.txState.setTextColor(UChainWalletApplication.getInstance().getResources().getColor(R.color.c_F5A623));
                holder.txTime.setVisibility(View.INVISIBLE);
                break;
            default:
                break;
        ...
        switch (assetID) {
            case Constant.ASSETS_NEO:
                GlideApp.with(UChainWalletApplication.getInstance()).load(R.drawable.logo_global_neo).into(holder.txLogo);
                break;
            case Constant.ASSETS_NEO_GAS:
                GlideApp.with(UChainWalletApplication.getInstance()).load(R.drawable.logo_global_gas).into(holder.txLogo);
                break;
            case Constant.ASSETS_CPX:
                GlideApp.with(UChainWalletApplication.getInstance()).load(R.drawable.logo_nep5_cpx).into(holder.txLogo);
                break;
            case Constant.ASSETS_APH:
                GlideApp.with(UChainWalletApplication.getInstance()).load(R.drawable.logo_nep5_aph).into(holder.txLogo);
                break;
            case Constant.ASSETS_AVA:
                GlideApp.with(UChainWalletApplication.getInstance()).load(R.drawable.logo_nep5_ava).into(holder.txLogo);
                break;
            case Constant.ASSETS_DBC:
                GlideApp.with(UChainWalletApplication.getInstance()).load(R.drawable.logo_nep5_dbc).into(holder.txLogo);
                break;
            case Constant.ASSETS_EXT:
                GlideApp.with(UChainWalletApplication.getInstance()).load(R.drawable.logo_nep5_ext).into(holder.txLogo);
                break;
            case Constant.ASSETS_LRN:
                GlideApp.with(UChainWalletApplication.getInstance()).load(R.drawable.logo_nep5_lrn).into(holder.txLogo);
                break;
            case Constant.ASSETS_NKN:
                GlideApp.with(UChainWalletApplication.getInstance()).load(R.drawable.logo_nep5_nkn).into(holder.txLogo);
                break;
            case Constant.ASSETS_ONT:
                GlideApp.with(UChainWalletApplication.getInstance()).load(R.drawable.logo_nep5_ont).into(holder.txLogo);
                break;
            case Constant.ASSETS_PKC:
                GlideApp.with(UChainWalletApplication.getInstance()).load(R.drawable.logo_nep5_pkc).into(holder.txLogo);
                break;
            case Constant.ASSETS_RPX:
                GlideApp.with(UChainWalletApplication.getInstance()).load(R.drawable.logo_nep5_rpx).into(holder.txLogo);
                break;
            case Constant.ASSETS_SOUL:
                GlideApp.with(UChainWalletApplication.getInstance()).load(R.drawable.logo_nep5_soul).into(holder.txLogo);
                break;
            case Constant.ASSETS_SWTH:
                GlideApp.with(UChainWalletApplication.getInstance()).load(R.drawable.logo_nep5_swth).into(holder.txLogo);
                break;
            case Constant.ASSETS_TKY:
                GlideApp.with(UChainWalletApplication.getInstance()).load(R.drawable.logo_nep5_tky).into(holder.txLogo);
                break;
            case Constant.ASSETS_ZPT:
                GlideApp.with(UChainWalletApplication.getInstance()).load(R.drawable.logo_nep5_zpt).into(holder.txLogo);
                break;
            case Constant.ASSETS_PHX:
                GlideApp.with(UChainWalletApplication.getInstance()).load(R.drawable.logo_nep5_phx).into(holder.txLogo);
                break;
            case Constant.ASSETS_ETH:
                GlideApp.with(UChainWalletApplication.getInstance()).load(R.drawable.logo_global_eth).into(holder.txLogo);
                break;
            default:
        ...
        if (TextUtils.isEmpty(txAmount)) {
            UChainLog.e(TAG, "txAmount is null!");
            return;
        }
        ...
        try {
            ...
            UChainLog.e(TAG, "TransactionRecordRecyclerViewAdapter Exception:" + e.getMessage());
            return;
        }
