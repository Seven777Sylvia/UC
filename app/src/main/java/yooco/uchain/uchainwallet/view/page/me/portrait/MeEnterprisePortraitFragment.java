...
import yooco.uchain.uchainwallet.data.bean.json.PortraitEnterpriseEn;
import yooco.uchain.uchainwallet.data.bean.json.PortraitEnterpriseZh;
...
public class MeEnterprisePortraitFragment extends BaseFragment implements
    ...
    private void initView(View view) {
        ...
        mRv_portrait_enterprise.setLayoutManager(new LinearLayoutManager(UChainWalletApplication
