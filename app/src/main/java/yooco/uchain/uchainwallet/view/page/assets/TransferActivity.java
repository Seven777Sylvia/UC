...
import yooco.uchain.uchainwallet.utils.task.runnable.eth.GetEthGasPrice;
import yooco.uchain.uchainwallet.global.Constant;
import yooco.uchain.uchainwallet.presenter.transfer.CreateTxPresenter;
import yooco.uchain.uchainwallet.presenter.transfer.ICreateTxPresenter;
import yooco.uchain.uchainwallet.utils.ToastUtils;
import yooco.uchain.uchainwallet.utils.WalletUtils;
import yooco.uchain.uchainwallet.view.dialog.TransferPwdDialog;
...
public class TransferActivity extends BaseActivity implements View.OnClickListener,
    ...
    private void initData() {
        ...
        if (null == mBalanceBean) {
            UChainLog.e(TAG, "mBalanceBean is null!");
            return;
        }
    ...
    public void getEthGasPrice(String gasPrice) {
        if (TextUtils.isEmpty(gasPrice)) {
            UChainLog.e(TAG, "gasPrice is null!");
            return;
        }
        ...
        try {
            ...
            UChainLog.e(TAG, "mMinProgress NumberFormatException:" + e.getMessage());
        }
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    UChainLog.e(TAG, "gasFee Exception:" + e.getMessage());
                }
        ...
        switch (v.getId()) {
            case R.id.bt_transfer_send:
                ...
                if (TextUtils.isEmpty(addressFrom) || TextUtils.isEmpty(addressTo)) {
                    UChainLog.e(TAG, "addressFrom or addressTo is null or empty!");
                ...
                if (addressFrom.equals(addressTo)) {
                    UChainLog.e(TAG, "addressFrom equals addressTo!");
                    ToastUtils.getInstance().showToast(UChainWalletApplication.getInstance()
                ...
                if (!checkAddressIsLegal(walletType, addressTo)) {
                    UChainLog.e(TAG, "this address is Illegal!");
    ...
    public void onCheckPwd(Wallet wallet) {
        if (null == wallet) {
            UChainLog.e(TAG, "onCheckPwd() -> wallet is null!");
            return;
        }
